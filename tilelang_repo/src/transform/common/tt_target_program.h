...
public:
  TVM_DLL TTMeshPlan(ffi::String name, ffi::String mesh_kind,
                     ...
                     ffi::Array<Integer> device_range_shape,
                     ffi::String system_mesh_ref);
  TVM_FFI_DEFINE_OBJECT_REF_METHODS_NULLABLE(TTMeshPlan, ObjectRef,
                                             TTMeshPlanNode);
};
...
public:
  ...
  ffi::String core_local_address_mapping;
...
public:
  TVM_DLL TTBufferDistributionPlan(
      ...
      ffi::Array<Integer> source_region_shape,
      ffi::String logical_index_mapping, ffi::String core_local_address_mapping,
      ...
      ffi::Array<PrimExpr> local_shape, PrimExpr thread_extent,
      PrimExpr replicate_extent,
      ffi::Array<PrimExpr> inverse_logical_index_vars,
      ffi::Array<PrimExpr> inverse_logical_index_exprs,
      ffi::String spatial_layout, ffi::String spatial_distribution_kind,
      ffi::String abi_layout, ffi::String abi_memory_space);
  TVM_FFI_DEFINE_OBJECT_REF_METHODS_NULLABLE(TTBufferDistributionPlan,
                                             ObjectRef,
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTComputeOpPlan", TTComputeOpPlanNode,
                                    Object);
};

class TTComputeOpPlan : public ObjectRef {
public:
  TVM_DLL TTComputeOpPlan(
...
public:
  TVM_DLL TTTileComputeMaterializationDemand(
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTResourceDemand", TTResourceDemandNode,
                                    Object);
};
...
public:
  TVM_DLL TTBlockPlan(ffi::String name, ffi::String placement_kind,
                      ffi::Array<Integer> task_indices, ffi::String core_group,
                      int64_t core_group_index);
  TVM_FFI_DEFINE_OBJECT_REF_METHODS_NULLABLE(TTBlockPlan, ObjectRef,
                                             TTBlockPlanNode);
};
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTKernelPlan", TTKernelPlanNode,
                                    Object);
};

class TTKernelPlan : public ObjectRef {
public:
  TVM_DLL TTKernelPlan(ffi::String name, ffi::String kind,
                       ffi::String core_type, int64_t block_plan_index,
                       int64_t abi_plan_index);
  TVM_FFI_DEFINE_OBJECT_REF_METHODS_NULLABLE(TTKernelPlan, ObjectRef,
                                             TTKernelPlanNode);
};
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTKernelLaunchSpec",
                                    TTKernelLaunchSpecNode, Object);
};

class TTKernelLaunchSpec : public ObjectRef {
public:
  TVM_DLL TTKernelLaunchSpec(ffi::String core_type, ffi::String processor,
                             ffi::String noc);
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTKernelDefine", TTKernelDefineNode,
                                    Object);
};
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTTransportPlan", TTTransportPlanNode,
                                    Object);
};

class TTTransportPlan : public ObjectRef {
public:
  TVM_DLL TTTransportPlan(ffi::String name, ffi::String kind,
                          int64_t source_task_index, int64_t target_task_index,
                          ffi::String value_kind, ffi::String delivery_kind,
                          ffi::String subject);
  TVM_FFI_DEFINE_OBJECT_REF_METHODS_NULLABLE(TTTransportPlan, ObjectRef,
                                             TTTransportPlanNode);
};
...
public:
  TVM_DLL TTSyncPlan(ffi::String name, ffi::String kind,
                     int64_t source_task_index, int64_t target_task_index,
                     ffi::String ordering_kind, ffi::String completion_kind);
  TVM_FFI_DEFINE_OBJECT_REF_METHODS_NULLABLE(TTSyncPlan, ObjectRef,
                                             TTSyncPlanNode);
};
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTSemaphorePlan", TTSemaphorePlanNode,
                                    Object);
};

class TTSemaphorePlan : public ObjectRef {
public:
  TVM_DLL TTSemaphorePlan(ffi::String name, ffi::String kind,
                          int64_t semaphore_id, int64_t initial_value,
                          ffi::String core_type, int64_t source_task_index,
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTComputeSyncPlan",
                                    TTComputeSyncPlanNode, Object);
};

class TTComputeSyncPlan : public ObjectRef {
public:
  TVM_DLL TTComputeSyncPlan(ffi::String name, ffi::String kind,
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTDstLayoutPlan", TTDstLayoutPlanNode,
                                    Object);
};

class TTDstLayoutPlan : public ObjectRef {
public:
  TVM_DLL TTDstLayoutPlan(ffi::String name, ffi::String buffer,
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTLiveFormPlan", TTLiveFormPlanNode,
                                    Object);
};
...
public:
  TVM_DLL TTLiveFormPlan(ffi::String name, ffi::String logical_value,
                         ...
                         ffi::String execution_topology,
                         int64_t physical_local_extent,
                         int64_t logical_element_count,
                         ffi::String ownership_kind);
  TVM_FFI_DEFINE_OBJECT_REF_METHODS_NULLABLE(TTLiveFormPlan, ObjectRef,
                                             TTLiveFormPlanNode);
};
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTMaterializationPlan",
                                    TTMaterializationPlanNode, Object);
};

class TTMaterializationPlan : public ObjectRef {
public:
  TVM_DLL TTMaterializationPlan(
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTConsumerBindingPlan",
                                    TTConsumerBindingPlanNode, Object);
};

class TTConsumerBindingPlan : public ObjectRef {
public:
  TVM_DLL TTConsumerBindingPlan(
...
public:
  TVM_DLL
  TTCompileTimeArgSpec(ffi::String name, ffi::String kind, ffi::String dtype,
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTAccessorSpec", TTAccessorSpecNode,
                                    Object);
};
...
public:
  TVM_DLL TTAccessorSpec(ffi::String buffer, int64_t compile_time_arg_offset,
                         ...
                         int64_t common_runtime_arg_count,
                         int64_t args_config_bits, int64_t transport_page_size,
                         ffi::String layout, ffi::String memory_space,
                         ffi::Array<Integer> host_axis_order,
                         bool transpose_2d);
...
public:
  ...
  static void RegisterReflection();
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("tl.TTExecutionPlan", TTExecutionPlanNode,
                                    Object);
};

class TTExecutionPlan : public ObjectRef {
public:
  TVM_DLL TTExecutionPlan(ffi::String name,
                          ffi::Array<ffi::String> kernel_names,
                          ffi::Array<Integer> phase_indices);

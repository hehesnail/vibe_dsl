...
TIR_DEFINE_BUILTIN(guard_mask_to_cb)
...
TVM_REGISTER_OP("tl.blackhole.zero_cb_page")
    .set_num_inputs(3)
    .set_attr<TCallEffectKind>("TCallEffectKind", Integer(CallEffectKind::kOpaque))
    .add_argument("cb_id", "int", "Destination CB ID")
    .add_argument("page_bytes", "int", "Page size in bytes")
...
TVM_REGISTER_OP("tl.blackhole.guard_mask_to_cb")
    .set_num_inputs(4)
    .set_attr<TCallEffectKind>("TCallEffectKind", Integer(CallEffectKind::kOpaque))
    .add_argument("cb_id", "int", "Destination CB ID")
    .add_argument("bound_value", "int", "Exclusive upper bound admitted by the mask")
    .add_argument("base_value", "int", "First logical position represented by this mask tile")

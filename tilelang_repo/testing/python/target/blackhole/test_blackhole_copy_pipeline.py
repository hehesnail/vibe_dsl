...
def test_blackhole_leaf_readers_do_not_keep_legacy_defaults_or_slot_fallbacks():
    ...
    forbidden_snippets = {
        ...
        TRANSFORM_SRC_DIR / "lower_blackhole_ops.h": [
            "needs_bound_value_arg_",
            "needs_dynamic_value_arg_",
            "needs_base_value_arg_",
            "needs_extent_value_for_base_arg_",
            "bound_value_table_buffer_name_",
            "base_value_table_buffer_name_",
            "extent_value_for_base_table_buffer_name_",
            "bound_value_shared_buffer_names_",
            "base_value_shared_buffer_names_",
            "bound_value_runtime_arg_vars_",
            "bound_value_runtime_arg_names_",
            "runtime_arg_tile_start_scale_by_name_",
            "runtime_arg_tile_start_scale_by_var_",
        ],

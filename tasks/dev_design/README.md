...
| `stage4_phase_b_spatial_ir.md` | `Spatial Program IR` 详细设计、稳定边界与未完成 contract 设计 | compile-path 已完成；仍是 `Phase C` 的活跃输入边界 |
...
| `stage4_phase_b_spatial_ir.md` | `Spatial Program IR` 实施文档 | compile-path 已完成；contract hardening 仍进行中 |

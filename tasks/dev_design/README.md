...
| `2026-05-18-blackhole-t10-production-reducer.md` | Completed T10.4 partial-K GEMM reducer contract for the admitted local subset: reducer ownership, scratch lifetime/placement, transport, route, accumulation order, final-writer timing, and the temporal-wave fail-closed boundary live in `TTProgram -> ExecutableSpec`. |

...
| `2026-05-18-blackhole-t10-ccl-runtime-correctness.md` | Active T10 CCL runtime-correctness slice: all-gather / reduce-scatter / all-to-all must run through `BlackholeModule` on TT-Sim bf16 and compare against host references; typed contracts are a prerequisite, not the completion point. |

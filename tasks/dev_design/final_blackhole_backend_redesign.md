...
- backend cleanup review 与重文件边界拆分草案已建档：`stage4_backend_cleanup_roadmap.md`；cleanup A1/A3 已完成，A2 已落首轮 schema-driven buffer materialization 骨架，B1 已完成首轮 `BlackholeModule` helper 边界拆分，B2 已完成首轮 stick/page boundary 收敛

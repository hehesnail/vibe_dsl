...
- `rt_mod_blackhole` 已切到 `blackhole.cb_configs / core_plan / target_mode` 主路径
- runner 已切到 `spec.json + input.bin + output.bin`
- runner 源码和构建入口已收回 `tilelang_repo/tools/blackhole_runner/`

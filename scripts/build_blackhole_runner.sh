...
BUILD_DIR="${TILELANG_BLACKHOLE_RUNNER_BUILD_DIR:-$TT_METAL_HOME/build_Release}"
...
echo ""
echo "Build complete!"
echo "Runner executable: $BUILD_DIR/programming_examples/tilelang_blackhole_runner"
echo ""
echo "To use the runner, either:"
echo "1. Add $BUILD_DIR/programming_examples to your PATH, or"
echo "2. Set TILELANG_BLACKHOLE_RUNNER environment variable:"
echo "   export TILELANG_BLACKHOLE_RUNNER=$BUILD_DIR/programming_examples/tilelang_blackhole_runner"
